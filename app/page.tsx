...
<div className="flex flex-col min-h-screen justify-center">
  <main className="flex-1 flex flex-col items-center justify-start px-0 mt-8 md:mt-12">
    <section className="text-center py-1 mb-24">
      <div className="w-full max-w-screen-lg">
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
          <div className="flex flex-col justify-center space-y-4">
            <div className="space-y-2 text-left">
            <p className="max-w-[700px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-md/relaxed">
